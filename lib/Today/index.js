...
var Today = function (_PureComponent) {
  ...
  Today.prototype.render = function render() {
    ...
    return _react2.default.createElement(
      'div',
      {
        className: (0, _classnames2.default)(styles.root, (_classNames = {}, _classNames[styles.hide] = showObject.hide === true, _classNames[styles.chevronUp] = showObject.direction === DIRECTION_UP, _classNames[styles.chevronDown] = showObject.direction === DIRECTION_DOWN, _classNames)),
        style: {
