...
var Day = function (_PureComponent) {
  ...
  function Day() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, _PureComponent.call.apply(_PureComponent, [this].concat(args))), _this), _this.handleClick = function () {
      ...
      if (!isDisabled && typeof onClick === 'function') {
        onClick((0, _parse2.default)(date), beforeLastDisabled, isPreSelected);
      }
  ...
  Day.prototype.render = function render() {
    ...
    return _react2.default.createElement(
      'li',
      _extends({
        className: (0, _classnames2.default)(styles.root, (_classNames = {}, _classNames[styles.today] = isToday, _classNames[styles.highlighted] = isHighlighted, _classNames[styles.selected] = isSelected, _classNames[styles.preselected] = isPreSelected, _classNames[styles.prevdisabled] = prevDisabled, _classNames[styles.nextdisabled] = nextDisabled, _classNames[styles.disabled] = isDisabled, _classNames[styles.enabled] = !isDisabled, _classNames[styles.beforelast] = beforeLastDisabled, _classNames), className),
