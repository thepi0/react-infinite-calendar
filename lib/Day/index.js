...
var Day = function (_PureComponent) {
  ...
  function Day() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, _PureComponent.call.apply(_PureComponent, [this].concat(args))), _this), _this.handleClick = function () {
      ...
      if (isDisabled) {
        ...
        onClick((0, _parse2.default)(date), beforeLastDisabled, isPreSelected, originalDisabledDates, fromTop);
      }
      ...
      if (isDisabled) {
        ...
        onTouchStart((0, _parse2.default)(date), beforeLastDisabled, isPreSelected, originalDisabledDates, fromTop);
      }
      ...
      if (isDisabled) {
        ...
        onTouchEnd((0, _parse2.default)(date), beforeLastDisabled, isPreSelected, originalDisabledDates, fromTop);
      }
  ...
  Day.prototype.render = function render() {
    ...
    return _react2.default.createElement(
      ...
      day,
      !beforeLastDisabled && isVacation ? _react2.default.createElement('div', { className: styles.vacationCircle }) : null,
