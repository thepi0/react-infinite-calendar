...
var Day = function (_PureComponent) {
  ...
  function Day() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, _PureComponent.call.apply(_PureComponent, [this].concat(args))), _this), _this.onSelectionStart = function () {
      ...
      var fromTop = _reactDom2.default.findDOMNode(_this).getBoundingClientRect().top;
      ...
      if (isWeekend || beforeLastDisabled && !isPreSelected || vacationObject && vacationObject.vacation_type === 'holiday' || vacationObject && vacationObject.vacation_type === 'no-reservation' || selectionType === 'not_preselected' && isPreSelected && isDisabled || selectionType === 'preselected' && !isPreSelected && isDisabled || !isPreSelected && selectionType === 'preselected' || isPreSelected && selectionType === 'not_preselected') {
        ...
        onSelectionStart((0, _parse2.default)(date), beforeLastDisabled, isPreSelected, originalDisabledDates, fromTop);
      }
      ...
      if (typeof onSelectionEnd === 'function') {
        onSelectionEnd(e, (0, _parse2.default)(date), beforeLastDisabled, isPreSelected, originalDisabledDates, fromTop);
      }
  ...
  Day.prototype.render = function render() {
    ...
    return _react2.default.createElement(
      'li',
      _extends({
        className: (0, _classnames2.default)(styles.root, (_classNames = {}, _classNames[styles.today] = isToday, _classNames[styles.selected] = isSelected && selectionType !== 'selected' || isArraySelected, _classNames[styles.preselected] = isPreSelected, _classNames[styles.prevdisabled] = prevDisabled, _classNames[styles.nextdisabled] = nextDisabled, _classNames[styles.disabled] = isDisabled || beforeLastDisabled && !isPreSelected || !isPreSelected && selectionType === 'preselected' || isPreSelected && selectionType === 'not_preselected', _classNames[styles.holiday] = vacationObject.vacation === true && vacationObject.vacation_type === 'holiday', _classNames[styles.noReservation] = vacationObject.vacation === true && vacationObject.vacation_type === 'no-reservation', _classNames[styles.hide] = vacationObject.vacation === true && vacationObject.hide === true, _classNames[styles.enabled] = !isDisabled, _classNames[styles.beforelast] = beforeLastDisabled, _classNames[styles.purple] = isPreSelected && colors.purple, _classNames[styles.blue] = isPreSelected && colors.blue, _classNames[styles.green] = isPreSelected && colors.green, _classNames[styles.orange] = isPreSelected && colors.orange, _classNames[styles.weekend] = isWeekend, _classNames[styles.preselecteddisabled] = isPreSelected && selectionType === 'not_preselected', _classNames[styles.preselectedenabled] = !isPreSelected && selectionType === 'preselected', _classNames), className),
      ...
      day,
      vacationObject.vacation ? _react2.default.createElement('div', { className: styles.vacationCircle }) : null,
