...
var Month = function (_PureComponent) {
    ...
    Month.prototype.renderRows = function renderRows() {
        ...
        for (var i = 0, len = rows.length; i < len; i++) {
            ...
            for (var k = 0, _len = row.length; k < _len; k++) {
                ...
                if (miniCalendar) {
                    if (!(0, _is_before2.default)(date, absoluteMin) && !(0, _is_after2.default)(date, absoluteMax) && dow !== 6 && dow !== 7) {
    ...
    Month.prototype.render = function render() {
        ...
        return _react2.default.createElement(
            ...
            _react2.default.createElement(
                'div',
                { className: (0, _classnames2.default)(styles.rows, (_classNames3 = {}, _classNames3[styles.mini] = miniCalendar, _classNames3)) },
                this.renderRows()
            )
        );
    };
