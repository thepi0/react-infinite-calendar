        ...
        for (var i = 0, len = rows.length; i < len; i++) {
            ...
            for (var k = 0, _len = row.length; k < _len; k++) {
                ...
                for (var x = 0, _len2 = initialDisabledDatesArray.length; x < _len2; x++) {
                    if ((0, _format2.default)(initialDisabledDatesArray[x].date, 'YYYY-MM-DD', { locale: locale.locale }) === (0, _format2.default)(date, 'YYYY-MM-DD') && initialDisabledDatesArray[x].type === 'vacation') {
                        isDateVacation = true;
                    }
                }
