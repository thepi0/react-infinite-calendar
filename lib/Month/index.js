    ...
    Month.prototype.renderRows = function renderRows() {
        ...
        for (var i = 0, len = rows.length; i < len; i++) {
            ...
            for (var k = 0, _len = row.length; k < _len; k++) {
                ...
                isDisabled = minDate && date < _minDate || maxDate && date > _maxDate || selectionArray.includes((0, _format2.default)(date, 'YYYY-MM-DD')) || disabledDays && disabledDays.length && disabledDays.indexOf(dow) !== -1 || initialDisabledDatesArray && selectionType === 'none' && initialDisabledDatesArray.indexOf(dateDisabled) !== -1 || initialDisabledDatesArray && selectionType === 'not_preselected' && initialDisabledDatesArray.map(function (e) {
                    return e.date;
                }).indexOf(dateDisabled.date) !== -1 || initialDisabledDatesArray && selectionType === 'preselected' && ((0, _is_date2.default)(lastSelectableDate) && (0, _is_before2.default)(date, lastDate) || initialDisabledDatesArray.map(function (e) {
