...
var Month = function (_PureComponent) {
    ...
    Month.prototype.renderRows = function renderRows() {
        ...
        if (selectionType === 'not_preselected' && disabledDatesArray != null && disabledDatesArray.length) {
            ...
            if (selected && selected.start_time && lastSelectableDate && lastSelectableDate.length && (0, _is_before2.default)(selected.start_time, lastSelectableDate)) {
                enabledDatesArray = enabledDatesArray.filter(function (date) {
                    return (0, _is_before2.default)(date, lastSelectableDate);
                });
            } else if (selected && selected.start_time && lastSelectableDate && lastSelectableDate.length && (0, _is_before2.default)(lastSelectableDate, selected.start_time)) {
                enabledDatesArray = enabledDatesArray.filter(function (date) {
                    return (0, _is_before2.default)(lastSelectableDate, date);
                });
            }
        ...
        for (var i = 0, len = rows.length; i < len; i++) {
            ...
            for (var k = 0, _len = row.length; k < _len; k++) {
                ...
                beforeLastDisabled = lastSelectableDate && lastSelectableDate.length && (0, _is_before2.default)(date, lastDate);
