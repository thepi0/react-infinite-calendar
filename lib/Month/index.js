...
var Month = function (_PureComponent) {
    ...
    Month.prototype.renderRows = function renderRows() {
        ...
        for (var i = 0, len = rows.length; i < len; i++) {
            ...
            for (var k = 0, _len = row.length; k < _len; k++) {
                ...
                isDisabled = minDate && date < _minDate || maxDate && date > _maxDate || selectionArray.includes((0, _format2.default)(date, 'YYYY-MM-DD')) || disabledDays && disabledDays.length && disabledDays.indexOf(dow) !== -1 ||
                ...
                ||*/
                initialDisabledDatesArray && selectionType === 'preselected' && (0, _is_date2.default)(lastSelectableDate) && (0, _is_before2.default)(date, lastDate)
                /*||
                ...
                (0, _is_date2.default)(lastSelectableDate) && (0, _is_before2.default)(date, lastDate);
            ...
            }
            {
                ...
                days.length ? monthRows[i] = _react2.default.createElement(
                    ...
                    {
                        key: 'Row-' + i,
                        className: (0, _classnames2.default)(styles.row, (_classNames = {}, _classNames[styles.partial] = !miniCalendar && row.length !== 7, _classNames), (_classNames2 = {}, _classNames2[styles.partial] = miniCalendar && row.length !== 5, _classNames2), (_classNames3 = {}, _classNames3[styles.first] = miniCalendar && i == 0, _classNames3), (_classNames4 = {}, _classNames4[styles.second] = miniCalendar && i == 1, _classNames4)),
    ...
    Month.prototype.render = function render() {
        ...
        return _react2.default.createElement(
            'div',
            { className: (0, _classnames2.default)(styles.root, (_classNames5 = {}, _classNames5[styles.multiple] = miniCalendar && this.props.rows.length > 1, _classNames5)), style: _extends({}, style, { lineHeight: rowHeight + 'px' }) },
            !miniCalendar ? _react2.default.createElement(
                'div',
                { className: (0, _classnames2.default)(styles.indicator, (_classNames6 = {}, _classNames6[styles.indicatorCurrent] = isCurrentMonth, _classNames6)) },
            ...
            _react2.default.createElement(
                'div',
                { className: (0, _classnames2.default)(styles.rows, (_classNames7 = {}, _classNames7[styles.mini] = miniCalendar, _classNames7)) },
                this.renderRows()
            )
        );
    };
