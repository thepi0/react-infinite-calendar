...
var Calendar = function (_Component) {
  ...
  function Calendar(props) {
    ...
    _this.updateTodayHelperPosition = function (scrollSpeed) {
      ...
      var newState = { show: false, direction: null };
      ...
      if (scrollTop >= _this._todayOffset + (height - rowHeight) / 2 + rowHeight * todayHelperRowOffset) {
        if (showToday !== _Today.DIRECTION_UP) {
          newState = { show: true, direction: _Today.DIRECTION_UP };
        }
      }
      // Today is below the fold
      else if (scrollTop <= _this._todayOffset - height / 2 - rowHeight * (todayHelperRowOffset + 1)) {
          if (showToday !== _Today.DIRECTION_DOWN) {
            newState = { show: true, direction: _Today.DIRECTION_DOWN };
          }
  ...
  Calendar.prototype.updateOriginalDisabledDates = function updateOriginalDisabledDates() {
    ...
    if (props.miniCalendar && props.min) {
      var today = (0, _start_of_day2.default)(new Date());
      var absoluteMin = (0, _format2.default)(props.min, 'YYYY-MM-DD');
      var beforeDays = (0, _is_before2.default)(absoluteMin, today) ? (0, _each_day2.default)(absoluteMin, (0, _sub_days2.default)(today, 1), 1) : null;

      if (beforeDays && beforeDays.length) {
        for (var p = 0, length = beforeDays.length; p < length; ++p) {
          beforeDays[p] = { date: (0, _format2.default)(beforeDays[p], 'YYYY-MM-DD'), type: 'no-reservation', hide: true };
  ...
  Calendar.prototype.render = function render() {
    ...
    return _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        showWeekdays && _react2.default.createElement(_Weekdays2.default, { weekdays: locale.weekdays, miniCalendar: miniCalendar, weekStartsOn: locale.weekStartsOn, theme: theme }),
        _react2.default.createElement(
          'div',
...
process.env.NODE_ENV !== "production" ? Calendar.propTypes = {
  ...
  miniCalendar: _propTypes2.default.bool,
