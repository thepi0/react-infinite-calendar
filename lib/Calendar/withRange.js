...
function getPreselectedWithinRange(start_date, end_date, preselected, selected, originalDisabledDates) {
    ...
    if (preSelectedSelected && preselected) {
        ...
        var start = (0, _is_before2.default)(start_date, end_date) ? start_date : end_date;
        var end = (0, _is_before2.default)(start_date, end_date) ? end_date : start_date;
        ...
        while (start <= end) {
            ...
            if (!thesame) {
                for (var i = 0, disabled = originalDisabledDates.length; i < disabled; ++i) {
                    ...
                    if (disabled_start === (0, _format2.default)(start, 'YYYY-MM-DD') && originalDisabledDates[i].type === 'holiday') {
                        thesame = true;
                        break;
                    }
                }
