...
function handlePreselected(preselected) {
    ...
    var _loop = function _loop(k, _day) {
        var dayStart = (0, _format2.default)(days[k].start_time, 'YYYY-MM-DD');
...
function handleSelectionEnd(e, date, beforeLastDisabled, isPreSelected, originalDisabledDates, fromTop, _ref8) {
    ...
    if (selectionType === 'selected') {
        ...
        selectionStart = (0, _format2.default)(selectionStart, 'YYYY-MM-DD');
        var daysArray = [];
        ...
        for (var i = 0, length = daysBetween.length; i < length; ++i) {
            var dayBetween = (0, _format2.default)(daysBetween[i], 'YYYY-MM-DD');
            var shouldRemove = (0, _is_saturday2.default)(dayBetween) || (0, _is_sunday2.default)(dayBetween);
            ...
            if (!shouldRemove && !alreadyIncluded) {
                for (var b = 0, _length = preselected.length; b < _length; ++b) {
                    if ((0, _format2.default)(preselected[b].start_time, 'YYYY-MM-DD') === dayBetween) {
        ...
        for (var _i = 0, _length2 = _daysBetween.length; _i < _length2; ++_i) {
            var _dayBetween = (0, _format2.default)(_daysBetween[_i], 'YYYY-MM-DD');
            var _shouldRemove = (0, _is_saturday2.default)(_dayBetween) || (0, _is_sunday2.default)(_dayBetween);
